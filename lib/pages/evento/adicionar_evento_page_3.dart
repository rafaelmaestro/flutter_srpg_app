...
class AdicionarEventoPage3 extends StatefulWidget {
  Evento eventoASerCriado;
  AdicionarEventoPage3({super.key, required this.eventoASerCriado});

  @override
  _EventoAlunoPageState createState() => _EventoAlunoPageState();
}

class _EventoAlunoPageState extends State<AdicionarEventoPage3> {
    ...
    try {
      ...
      await EventoRepository().criarEvento(
        ...
        distanciaMaximaPermitida:
            widget.eventoASerCriado.distanciaMaximaPermitida ?? 20,
        minutosTolerancia: widget.eventoASerCriado.minutosTolerancia ?? 20,
